  ...
  return (
      ...
      <div className="WhoWeArePanel">
        ...
        <div className="WhyOrderPanel__Reasons">
          <div className="WhyOrderPanel__Reasons__Reason__Discover">
            <div className="WhyOrderPanel__Reasons__Reason__Discover__ImageWrap">
              <img className="Discover__Image" src="https://smart.servier.com/wp-content/uploads/2016/10/ECGentier5.png"/>
            </div>
            <h3 className="WhyOrderPanel__Reasons__Reason__Headline">DISCOVER</h3>
          ...
          <div className="WhyOrderPanel__Reasons__Reason__Discover">
            ...
            <h3 className="WhyOrderPanel__Reasons__Reason__Headline">EXPLORE</h3>
          ...
          <div className="WhyOrderPanel__Reasons__Reason__Discover">
            ...
            <h3 className="WhyOrderPanel__Reasons__Reason__Headline">SHARE</h3>
